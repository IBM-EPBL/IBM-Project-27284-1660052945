...
def submit(name,email_id,phone_number,message):
  ...
  'authDomain': "banking-feedback.firebaseapp.com",
    "databaseURL":"https://banking-feedback-default-rtdb.firebaseio.com",
  'projectId': "banking-feedback",
  'storageBucket': "banking-feedback.appspot.com",
